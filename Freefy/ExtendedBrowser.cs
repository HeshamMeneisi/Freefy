...
public class ExtendedWebBrowser : WebBrowser
{
    ...
    public delegate void PageLoadedEventHandler(WebBrowser sender, WebBrowserDocumentCompletedEventArgs e);
    bool renavigating = false, skip = false;
    ...
    {
        if (e.Url.AbsolutePath != Url.AbsolutePath) return;
        if (skip)
        {
            skip = false;
            return;
